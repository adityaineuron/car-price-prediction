...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        '''
        logger.info("Entered the initiate_model_evaluation methos of Model evaluation class")
        try:
            ...
            logger.info("Exited the initiate_model_evaluation methos of Model evaluation class")
